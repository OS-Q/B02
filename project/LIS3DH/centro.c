...
{		
	...
	LIS3DH_WriteReg(LIS3DH_CTRL_REG2, LIS3DH_REG2_INIT);
	LIS3DH_WriteReg(LIS3DH_CTRL_REG3, LIS3DH_REG3_INIT);
	LIS3DH_WriteReg(LIS3DH_CTRL_REG4, LIS3DH_REG4_INIT);
	LIS3DH_WriteReg(LIS3DH_CTRL_REG5, LIS3DH_REG5_INIT);
	LIS3DH_WriteReg(LIS3DH_CTRL_REG6, LIS3DH_REG6_INIT);	
	LIS3DH_WriteReg(LIS3DH_REFERENCE_REG, 0x00);	
	LIS3DH_WriteReg(LIS3DH_FIFO_CTRL_REG, LIS3DH_FIFO_CTRL_INIT);	
	//配置中断1
	LIS3DH_WriteReg(LIS3DH_INT1_CFG, LIS3DH_INT1_CTRL_INIT);
	LIS3DH_WriteReg(LIS3DH_INT1_THS, LIS3DH_INT1_THS_DATA);
	LIS3DH_WriteReg(LIS3DH_INT1_DURATION, LIS3DH_DURATION_TIME);
	//配置中断2
	LIS3DH_WriteReg(LIS3DH_INT2_CFG, 0x00);	
	LIS3DH_WriteReg(LIS3DH_INT2_THS, 0x08);	
	...
	LIS3DH_WriteReg(LIS3DH_TEMP_CFG_REG, LIS3DH_TEMP_INIT);	
